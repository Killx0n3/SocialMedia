...
class SocialMediaDb:
    """
    Provide an interface to the database for a Social Media web application
    """
    ...
    def __init__(self, test=False):
        ...
        otherwise use a database file called social_media.db
        """

        if test:
            self.dbname = ":memory:"
        else:
            self.dbname = "social_media.db"
